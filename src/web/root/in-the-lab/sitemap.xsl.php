...
function render() { header( 'Content-Type: application/xslt+xml; charset=UTF-8' ); }
			...
			<nav class="navigation">
				<section class="container">
					...
					<div class="menu-list">
						...
						<a class="internal" href="<?= $url_base ?>/feed.php" title="In The Lab With Jay Jay » Feed">
							<img src="<?= $cdn_base ?>/img/rss/rss-40674_50.png" style="display:inline-block;width:50px;height:auto;vertical-align:top;margin-top:0px;" /></a></div></section></nav>
			<header id="banner">
