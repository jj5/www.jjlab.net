...
channel(
  ...
  show_type(
    ...
    feature(
      feature_slug( 'advent-2025' ),
      feature_name( 'Maker Advent Calendar 2025' ),
      feature_text( 'In the Maker Advent Calendar 2025 videos we work our way through the Maker Advent Calendar 2025.' ),
    ),
    feature(
