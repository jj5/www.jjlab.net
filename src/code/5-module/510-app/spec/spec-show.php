...
show(
  ...
  old_book_teardown(
    ...
    old_book(
      ...
      page_count( 680 ),
      affiliate_link(
        equipment_url ( 'https://blog.jj5.net/blog/2023/11/30/in-the-lab-with-jay-jay-november-30-2023-teardown-of-homemade-continuity-tester/' ),
      ),
    ),
  ),
);
...
show(
  mail_call(
    ...
    title( 'More Loot from Amazon and AliExpress!' ),
    // 2024-08-12 jj5 - NEW:
    youtube_video( 'U5Uicx8KIgk' ),
    // 2024-08-12 jj5 - OLD: video processing stalled on this one so I reuploaded it...
    //youtube_video( 'IcWDobo0Nok' ),
    blog_url( 'https://blog.jj5.net/blog/2024/08/11/mail-call-6-more-loot-from-amazon-and-aliexpress-learning-electronics-in-the-lab-with-jay-jay/' ),
...
show(
  mail_call(
    ...
    title( 'Latest Loot from AliExpress' ),
    youtube_video( '7D2cWrSIK-A' ),
    blog_url( 'https://blog.jj5.net/blog/2024/10/14/mail-call-12-latest-loot-from-aliexpress-learning-electronics-in-the-lab-with-jay-jay/' ),
...
show(
  mail_call(
    ...
    title( 'Latest Loot from Amazon and AliExpress' ),
    youtube_video( 'EvpTvHPzyHE' ),
    blog_url( 'https://blog.jj5.net/blog/2024/10/25/mail-call-13-latest-loot-from-amazon-and-aliexpress-learning-electronics-in-the-lab-with-jay-jay/' ),
...
show(
  demo(
    ...
    blog_url( 'https://blog.jj5.net/blog/2025/01/12/demo-5-peak-electronic-design-atlas-lcr45-lcr-component-meter-with-impedance-measurement/' ),
    patreon_url( 'https://www.patreon.com/posts/119551211' ),
    tags(
      'jjlab', 'Demo', 'Demonstration',
      'Unboxing', 'Electronics', 'Hardware', 'Instrument', 'Testing', 'Measurement', 'Tool',
      'Peak Electronic Design', 'Atlas LCR45', 'LCR Meter',
      'EEVblog Forum',
      'ALKOY', 'Capacitor Discharge Pen',
...
show(
  interlude(
    ...
    blog_url( 'https://blog.jj5.net/blog/2025/01/22/interlude-12-the-making-of-the-hook-stick-extension-grabber-thing-in-the-lab-with-jay-jay/' ),
    patreon_url( 'https://www.patreon.com/posts/120289414' ),
    tags(
      'jjlab', 'Interlude', 'Hook Stick Extension Grabber Thing',
      'Ali the Dazzling',
      'Deep Hole Long Nib Pen',
      'Rockwell', 'RD2971', '18V Drill Driver Kit',
      'Bosch', 'IXO VI', 'Electric Screwdriver',
      'Pegboard', 'Peg Board', 'Hooks',
      'Cordless Hand Held Vacuum',
      'File and Rasp Set',
      'Plato', 'Model 170', 'Wire Cutter',
      '8-Port HDMI KVM',
      'UPERFECT 15.6" HDMI LCD',
      'Jaycar HB6330 33 Drawer Parts Cabinet',
    ),
  ),
);
...
show(
  ...
  maxitronix_segment(
    ...
    title( 'The "Invisible Power" Radio' ),
    project( 4, 30 ),
    maxitronix_kit_name( '30in1' ),
    youtube_video( 'eFXAw9nwCkE' ),
    blog_url( 'https://blog.jj5.net/blog/2025/11/06/the-invisible-power-radio-project-4-30-maxitronix-30in1-in-the-lab-with-jay-jay/' ),
    patreon_url( 'https://www.patreon.com/posts/142779148' ),
    tags(
      'jjlab', 'Maxitronix 30in1', 'Electronics Project', 'Lab', 'Kit', 'Circuit', 'Experiment',
      'The Invisible Power Radio',
    ),
  ),
);
...
show(
  ...
  mail_call(
    ...
    title( 'Stamp Breakout Boards, DIY Telegraph Machine, PTZ Mount with Servos, and More!' ),
    youtube_video( 'FCoop4Nuoos' ),
    blog_url( 'https://blog.jj5.net/blog/2025/11/12/mail-call-51-stamp-breakout-boards-diy-telegraph-machine-ptz-mount-with-servos-and-more/' ),
    patreon_url( 'https://www.patreon.com/posts/143362555' ),
    tags(
      'jjlab', 'Mail Call', 'AliExpress',
      'Sciotronics Stamp Breakout Board',
      'NRF24L01 Wireless Adapter Module',
      'IDE Data Extension Cable Cable for OG Xbox',
      'MY-065 Nano Cleaning Sponge',
      'Photoelectric Beam Speed Sensor',
      '2x4 Keypad',
      'Heat-Resistant Flame-Retardant Tape',
      'High Temperature Wire Harness Cloth Tape',
      'Glue Spreaders',
      'Educational Glass Prism',
      'T-type 3mm to 6mm Hand Tapping Tool',
      'Precision Titanium Alloy Tweezers',
      'Chinese Calligraphy Brush Set',
      '12V Mini Tungsten Lamp Bulb',
      'Tilt Vibration Sensor Module',
      'SW-420 Normally Closed Alarm Vibration Sensor Module',
      '5PCS Mini Pen Knife',
      'DIY Telegraph Machine',
      'Pan-Tilt-Zoom Camera Mount with Servos',
      'Wire Stripping Tool',
      'Flexible LED Filament',
      '2N3819 TO-92 N-Channel Field-Effect Transistor JFET',
      'TCS3472 Color Recognition Sensor Module',
      '4x4 Matrix Keypad With 16 Buttons',
      'DIY Wireless Stereo FM Radio Receiver Module',
      'Five-way Navigation Key Module',
      'Black Electrical Heat-Resistant Tape',
      'Multipurpose Laser Spirit Level Kit',
    ),
  ),
);
...
show(
  ...
  mail_call(
    ...
    title( 'Microphones, Diodes, Costumes, Markers, LED Filament, Heat Inserts and More!' ),
    youtube_video( 'ZKW18reKzDk' ),
    blog_url( 'https://blog.jj5.net/blog/2025/11/26/mail-call-53-microphones-diodes-costumes-markers-led-filament-heat-inserts-and-more/' ),
    patreon_url( 'https://www.patreon.com/posts/144374733' ),
    tags(
      'jjlab', 'Mail Call', 'AliExpress', 'Amazon',
      'Condenser Microphone', 'SMD Diode Sample Book', 'Scientist Lab Costume for Kids',
      'Acrylic Markers', 'Flexible LED Filament',
      'Brass Heat Insert Nut Hot Melt M2 M2.5 M3 M4 M5 M6',
      'Acrylic Paint Markers Set',
      'Thread Insert M3 M4 M5 M6 M8 M10 M12',
      '6pcs Sculpting Pottery Clay Tools',
      'Heat Insert Nut Soldering Iron Tip',
      'Angled Hose Pliers',
      'Insulation Piercing Probes',
      'Heat Set Insert Soldering Iron Tip',
      'Banana Plug to Alligator Clip Cable',
      'Thread Checker Screw Measurement Ruler',
      '10pcs Piercing Needle Probe',
      'Paint Tray',
      '10pcs Disposable Plastic 5ml Syringe',
      'Glue Applicator Syringe with Tips',
      'ANENG PT2003 Needle Probes',
      'ANENG PT2002 Insulation Piercing Needle',
      '20pcs SOT23 Double-Sided SMD Circuit Boards',
      '40-Pin Narrow ZIF Socket',
      '40-Pin Wide ZIF Socket',
      '100pcs JST PH Right Angle Socket',
      '50pcs M3 16mm Screws',
      '50pcs M3 2mm Screws',
      'PLCC IC Chip Extractor',
      'U-Shaped IC Chip Puller',
      'Vacuum Suction Pen for IC Chips',
      '2.4 inch TFT LCD Display with EC11 Rotary Encoder Combined Module ST7789 320x240 RGB for Arduino',
      '1.8 inch TFT LCD Display with EC11 Rotary Encoder Combined Module ST7735S 128x160 RGB for Arduino',
      'BST-66 Solder Pad Repair Spots',
...
show(
  ...
  maxitronix_segment(
    ...
    tags(
      'jjlab', 'Maxitronix 30in1', 'Electronics Project', 'Lab', 'Kit', 'Circuit', 'Experiment',
      'The Transistor an Amplifier', 'AM Radio',
    ),
  ),
);
...
show(
  ...
  maxitronix_segment(
    ...
    title( 'The Sunrise-Sunset Light' ),
    project( 7, 30 ),
    maxitronix_kit_name( '30in1' ),
    youtube_video( 'rmuhA3vkyPo' ),
    blog_url( 'https://blog.jj5.net/blog/2025/12/04/the-sunrise-sunset-light-project-7-30-maxitronix-30in1-in-the-lab-with-jay-jay/' ),
    patreon_url( 'https://www.patreon.com/posts/145036371' ),
    tags(
      'jjlab', 'Maxitronix 30in1', 'Electronics Project', 'Lab', 'Kit', 'Circuit', 'Experiment',
      'The Sunrise-Sunset Light', 'Transistor', 'LED', 'Capacitor', 'Resistor',
    ),
  ),
);
...
show(
  ...
  learning_the_art(
    ...
    title( "Learning the Art of Electronics: 2N.2.1 Differentiators, Again" ),
    youtube_video( 'hggSJaBrGno' ),
    blog_url( 'https://blog.jj5.net/blog/2026/09/15/learning-the-art-of-electronics-2n-2-1-differentiators-again-in-the-lab-with-jay-jay/' ),
    patreon_url( 'https://www.patreon.com/posts/169542026' ),
    tags(
      'jjlab', 'Learning the Art of Electronics', 'Differentiator', 'RC Circuit', 'Resistor', 'Capacitor',
    ),
  ),
