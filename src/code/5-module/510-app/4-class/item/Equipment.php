...
function equipment() {
  ...
  return new_item( Equipment::class, func_get_args() );
...
class Equipment extends Item {
  ...
  public static function sort_expensive_first( &$equipment_list ) {
    ...
    usort(
      $equipment_list,
      function ( $a, $b ) { return $b->get_sort_value() - $a->get_sort_value(); }
    );
  ...
  public static function sort_new_first( &$equipment_list ) {
    ...
    usort(
      ...
      function ( $a, $b ) {
        ...
        return $b_value->getTimestamp() - $a_value->getTimestamp();
  ...
  public static function sort_old_first( &$equipment_list ) {
    ...
    usort(
      ...
      function ( $a, $b ) {
        ...
        return $a_value->getTimestamp() - $b_value->getTimestamp();
